...
export const PERMISSIONS: Record<Role, Permission[]> = {
    ...
    [Role.Accountant]: ['purchases:create', 'purchases:read', 'purchases:update', 'sales:read', 'employees:read', 'licenses:read', 'inventory:read', 'payroll:read', 'reports:read:limited', 'advances:request', 'general_requests:request', 'supply_chain:read'],
    [Role.BranchManager]: ['purchases:create', 'purchases:read', 'sales:create', 'sales:read', 'inventory:read', 'inventory:transfer', 'inventory:update', 'inventory:adjust', 'employees:read', 'manufacturing:create', 'manufacturing:read', 'manufacturing:tasks:manage', 'advances:manage', 'general_requests:manage', 'supply_chain:read', 'supply_chain:manage'],
...
export const PERMISSION_GROUPS: { [group: string]: { key: Permission, label: string }[] } = {
    ...
    'سلسلة التوريد': [
        { key: 'supply_chain:read', label: 'قراءة' },
        { key: 'supply_chain:manage', label: 'إدارة الشحنات' },
    ],
    'التجديدات': [
