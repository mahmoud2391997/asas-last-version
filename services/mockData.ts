...
export const MOCK_SALES_QUOTATIONS: SalesQuotation[] = [
    { id: 1, quoteNumber: 'QT-2024-001', customerId: 1, date: '2024-07-20', expiryDate: '2024-08-20', items: [{ productId: 8, productName: 'Arabiva Oud Royal 50ml', quantity: 10, unitPrice: 40, total: 400 }], totalAmount: 400, status: 'Sent', brand: 'Arabiva' },
    { id: 2, quoteNumber: 'QT-2024-002', customerId: 2, date: '2024-07-22', expiryDate: '2024-07-29', items: [{ productId: 9, productName: 'Generic Pure Musk Oil 12ml', quantity: 50, unitPrice: 10, total: 500 }], totalAmount: 500, status: 'Accepted', brand: 'Generic' },
];
...
export const MOCK_SHIPMENTS: Shipment[] = [
    {
        ...
        date: '2024-07-28',
        sourceType: 'Branch',
        sourceId: 4, // Central Warehouse
        destinationBranchId: 1, // Arabiva 1
        status: 'In Transit',
        items: [
            { productId: 8, quantity: 20 },
            { productId: 10, quantity: 15 }
        ],
        driverName: 'أحمد سائق',
        vehicleNumber: '9090-KWT',
        notes: 'نقل بضاعة اسبوعي'
    },
    {
        id: 2,
        ...
        sourceType: 'Supplier',
        sourceId: 1, // Supplier
        destinationBranchId: 4, // Warehouse
        status: 'Delivered',
        items: [
            { productId: 1, quantity: 1000 }
        ],
        notes: 'توريد مواد خام'
    }
];
