...
const allNavItems: NavItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { name: 'المخازن', view: 'Inventory/Warehouses' },
            ...
            { name: 'إدارة المستودعات', view: 'Branches' },
    ...
    {
        name: 'سلسلة التوريد', view: 'SupplyChain', icon: TruckIcon, permission: 'supply_chain:read',
        children: [
            { name: 'التوريدات', view: 'SupplyChain/Supplies' },
